...
int dios_ssp_vad_process_api(void *ptr_vad, float *vad_data, int dt_st) {
  ...
  // mix vad processing
  dios_ssp_vad_mix_process(energy_vad_result, dt_st, srv->vad_counter_ptr, signal_dev_value, &srv->vad_temp_result,
                           srv->voice_state);
  dios_ssp_vad_mix_stric_process(energy_vad_stric_result, dt_st, srv->vad_counter_stric_ptr, signal_dev_value,
                                 &srv->vad_temp_stric_result, srv->voice_stric_state);
